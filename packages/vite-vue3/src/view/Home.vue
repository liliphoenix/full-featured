<template>
  <div class="flex h-full w-full flex-col">
    ...
    <section class="flex h-auto w-full flex-col items-center justify-center">
      ...
      <div class="flex">
        <div
          class="mr-10 rounded-md bg-sky-500 px-5 py-2 text-white transition-all hover:mr-4"
        >
          文档
        </div>
        <div
          class="hover:bg-gradient-r-to rounded-md bg-sky-500 px-5 py-2 text-white transition-all"
        >
          Github
        </div>
      </div>
